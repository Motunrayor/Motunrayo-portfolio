      ...
      <div className="mx-auto w-full max-w-content">
        <div className="relative grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div className="min-w-0">
            ...
            <Reveal delay={0.1}>
              <p className="mt-5 max-w-2xl break-words text-base leading-relaxed text-[var(--muted)] sm:text-lg">
                {hero.tagline}
              </p>
            </Reveal>
            ...
            <Reveal delay={0.14} className="mt-6">
              ...
              <p className="mt-2 break-words text-sm leading-relaxed text-[var(--muted)] sm:text-base">
                {about.summary}
              </p>
          ...
          <div className="min-w-0 space-y-4">
            <Reveal delay={0.16}>
              <InteractiveTilt
                className="mx-auto w-full max-w-[19rem] [perspective:1200px] sm:max-w-[22rem]"
                maxTilt={7}
              >
            ...
            <Reveal delay={0.2} className="grid gap-3 sm:grid-cols-3">
              {hero.stats.map((stat) => (
                <article
                  key={stat.label}
                  className="rounded-xl border border-[color:color-mix(in_srgb,var(--border),#000_18%)] dark:border-[var(--border)]/65 bg-[var(--surface)]/65 px-3 py-2 backdrop-blur-sm"
                >
